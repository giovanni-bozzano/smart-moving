    ...
    private Set<String> build(String type, Set<String> inferiors, String startType)
    {
        ...
        for (String inferiorType : directInferiors) {
            if (inferiorType.equals(startType)) {
                throw new UnsupportedOperationException("Can not sort ClientPlayerBase classes for method '" + this.methodName + "'. Circular superiority found including '" + startType + "'");
            }
            ...
            try {
                ...
                throw new UnsupportedOperationException("Can not sort ClientPlayerBase classes for method '" + this.methodName + "'. Circular superiority found including '" + inferiorType + "'", uoe);
            }
