...
public final class ClientPlayerBaseSorting
{
    ...
    // ############################################################################
    private String[] beforeGetFovModifierSuperiors;
    private String[] beforeGetFovModifierInferiors;
    private String[] overrideGetFovModifierSuperiors;
    private String[] overrideGetFovModifierInferiors;
    private String[] afterGetFovModifierSuperiors;
    private String[] afterGetFovModifierInferiors;
    // ############################################################################
    ...
    // ############################################################################
    private String[] beforeRecalculateSizeSuperiors;
    private String[] beforeRecalculateSizeInferiors;
    private String[] overrideRecalculateSizeSuperiors;
    private String[] overrideRecalculateSizeInferiors;
    private String[] afterRecalculateSizeSuperiors;
    private String[] afterRecalculateSizeInferiors;
    // ############################################################################
    ...
    // ############################################################################
    private String[] beforeSetPlayerSPHealthSuperiors;
    private String[] beforeSetPlayerSPHealthInferiors;
    private String[] overrideSetPlayerSPHealthSuperiors;
    private String[] overrideSetPlayerSPHealthInferiors;
    private String[] afterSetPlayerSPHealthSuperiors;
    private String[] afterSetPlayerSPHealthInferiors;
    // ############################################################################
    ...
    public String[] getBeforeRecalculateSizeSuperiors()
    {
        return this.beforeRecalculateSizeSuperiors;
    }

    public String[] getBeforeRecalculateSizeInferiors()
    {
        return this.beforeRecalculateSizeInferiors;
    }

    public String[] getOverrideRecalculateSizeSuperiors()
    {
        return this.overrideRecalculateSizeSuperiors;
    }

    public String[] getOverrideRecalculateSizeInferiors()
    {
        return this.overrideRecalculateSizeInferiors;
    }

    public String[] getAfterRecalculateSizeSuperiors()
    {
        return this.afterRecalculateSizeSuperiors;
    }

    public String[] getAfterRecalculateSizeInferiors()
    {
        return this.afterRecalculateSizeInferiors;
    }

    public void setBeforeRecalculateSizeSuperiors(String[] value)
    {
        this.beforeRecalculateSizeSuperiors = value;
    }

    public void setBeforeRecalculateSizeInferiors(String[] value)
    {
        this.beforeRecalculateSizeInferiors = value;
    }

    public void setOverrideRecalculateSizeSuperiors(String[] value)
    {
        this.overrideRecalculateSizeSuperiors = value;
    }

    public void setOverrideRecalculateSizeInferiors(String[] value)
    {
        this.overrideRecalculateSizeInferiors = value;
    }

    public void setAfterRecalculateSizeSuperiors(String[] value)
    {
        this.afterRecalculateSizeSuperiors = value;
    }

    public void setAfterRecalculateSizeInferiors(String[] value)
    {
        this.afterRecalculateSizeInferiors = value;
    }
