...
public class ModelCapeRenderer extends ModelSpecialRenderer
{
	...
	public void preTransform(float factor, boolean push)
	{
		...
		double d = (entityplayer.prevChasingPosX + (entityplayer.chasingPosX - entityplayer.prevChasingPosX) * setFactor) - (entityplayer.prevPosX + (entityplayer.posX - entityplayer.prevPosX) * setFactor);
		double d1 = (entityplayer.prevChasingPosY + (entityplayer.chasingPosY - entityplayer.prevChasingPosY) * setFactor) - (entityplayer.prevPosY + (entityplayer.posY - entityplayer.prevPosY) * setFactor);
		double d2 = (entityplayer.prevChasingPosZ + (entityplayer.chasingPosZ - entityplayer.prevChasingPosZ) * setFactor) - (entityplayer.prevPosZ + (entityplayer.posZ - entityplayer.prevPosZ) * setFactor);
