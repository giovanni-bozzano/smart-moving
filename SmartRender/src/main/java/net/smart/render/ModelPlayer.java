...
public class ModelPlayer extends net.minecraft.client.model.ModelPlayer implements IModelPlayer
{
	private final SmartRenderModel model;

	public ModelPlayer(net.minecraft.client.model.ModelBiped existing, float f, boolean b)
	{
		super(f, b);
		...
		model = new SmartRenderModel(b, this, this, existing.bipedBody, bipedBodyWear, existing.bipedHead, existing.bipedHeadwear, existing.bipedRightArm, bipedRightArmwear, existing.bipedLeftArm, bipedLeftArmwear, existing.bipedRightLeg, bipedRightLegwear, existing.bipedLeftLeg, bipedLeftLegwear, bipedCape, bipedDeadmau5Head);
	}
	...
	private static final Field _bipedCape = Reflect.GetField(net.minecraft.client.model.ModelPlayer.class, SmartRenderInstall.ModelPlayer_bipedCape);
	private static final Field _bipedDeadmau5Head = Reflect.GetField(net.minecraft.client.model.ModelPlayer.class, SmartRenderInstall.ModelPlayer_bipedDeadmau5Head);
}