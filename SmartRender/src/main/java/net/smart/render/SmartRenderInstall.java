...
public class SmartRenderInstall
{
	...
	public final static Name ModelRenderer_textureOffsetX = new Name("textureOffsetX", "field_78803_o", "r");
	...
	public final static Name RenderManager_renderPlayer = new Name("playerRenderer", "field_178637_m", "m");
	public final static Name RenderManager_skinMap = new Name("skinMap", "field_178636_l", "l");
}