...
public class Config extends Properties
{
    ...
    public final Property<Boolean> _freeClimbingAutoLaddder = Unmodified("move.climb.free.ladder.auto").depends(this._isFreeBaseClimb).comment("Whether the \"grab\" button will automatically be triggered while being on ladders and looking in the right direction").section();
    public final Property<Boolean> _freeClimbingAutoVine = Unmodified("move.climb.free.vine.auto").depends(this._isFreeBaseClimb).comment("Whether the \"grab\" button will automatically be triggered while being on standard climbable vines and looking in the right direction");
    ...
    public final Property<Float> _freeClimbFallMaximumDistance = Positive("move.climb.fall.maximum.distance").defaults(3F).min(this._freeClimbFallDamageStartDistance).comment("Distance in blocks to fall to block all climbing attempts (>= \"move.climb.fall.damage.start.distance\")");
    ...
    public final Property<Float> _climbExhaustionStop = Positive("move.climb.exhaustion.stop").up(80F, this._climbExhaustionStart).defaults(100F, _pre_sm_1_4).comment("Maximum exhaustion to climb (>= 0)");
    ...
    public final Property<Float> _ceilingClimbExhaustionStop = Positive("move.climb.ceiling.exhaustion.stop").up(60F, this._ceilingClimbExhaustionStart).defaults(100F, _pre_sm_1_4).comment("Maximum exhaustion to climbing along ceilings (>= \"move.climb.ceiling.exhaustion.start\")");
    ...
    public final Property<Boolean> _runExhaustion = Hard("move.run.exhaustion").depends(this._run).comment("To switch on/off standard sprinting exhaustion");
    ...
    public final Property<Float> _runExhaustionStop = Positive("move.exhaustion.run.stop").up(100F, this._runExhaustionStart).comment("Maximum exhaustion to continue a standard sprint (>= \"move.exhaustion.run.start\")");
    ...
    public final Property<Float> _sprintFactor = PositiveFactor("move.sprint.factor").defaults(1.5F).min(this._run.eitherOr(this._runFactor.plus(0.1F), 1.1F)).comment("Generic sprinting factor (>= 1.1 AND >= 'move.run.factor' + 0.1 if relevant)");
    public final Property<Boolean> _sprintExhaustion = Medium("move.sprint.exhaustion").depends(this._sprint).comment("To switch on/off sprinting exhaustion");
    ...
    public final Property<Float> _sprintExhaustionStop = Positive("move.exhaustion.sprint.stop").up(100F, this._sprintExhaustionStart).comment("Maximum exhaustion to continue a sprint (>= \"move.exhaustion.sprint.start\")");
    ...
    public final Property<Float> _fallAnimationDistanceMinimum = Positive("move.fall.animation.distance.minimum").min(this._fallingDistanceMinimum).defaults(3F, _pre_sm_1_6).comment("Minimum fall distance for the smart falling animation (>= 0, >= \"move.fall.animation.distance.minimum\"");
    ...
    public final Property<Boolean> _standJump = Unmodified("move.jump.stand").depends(this._jump).comment("To switch on/off jumping while standing (Relevant only if \"move.jump\" is true)").chapter();
    ...
    public final Property<Boolean> _sneakJump = Unmodified("move.jump.sneak").key("move.sneak.jump", _pre_sm_1_7).depends(this._sneak, this._jump).comment("To switch on/off jumping while sneaking (Relevant only if nether \"move.sneak\" nor \"move.jump\" are false)").chapter();
    ...
    public final Property<Boolean> _walkJump = Unmodified("move.jump.walk").depends(this._jump).comment("To switch on/off jumping while walking (Relevant only if \"move.jump\" is true)").chapter();
    ...
    public final Property<Boolean> _runJump = Unmodified("move.jump.run").key("move.run.jump", _pre_sm_1_7).depends(this._run, this._jump).comment("To switch on/off jumping while running (Relevant only if nether \"move.run\" nor \"move.jump\" are false)").chapter();
    ...
    public final Property<Boolean> _sprintJump = Unmodified("move.jump.sprint").key("move.sprint.jump", _pre_sm_1_7).depends(this._sprint, this._jump).comment("To switch on/off jumping while sprinting (Relevant only if nether \"move.sprint\" nor \"move.jump\" are false)").chapter();
    ...
    public final Property<Boolean> _jumpCharge = Unmodified("move.jump.charge").depends(this._jump).comment("Relevant only if \"move.jump\" is not false").chapter("Charged jumping", "Below you find all charged jump specific options except those for exhaustion.");
    ...
    public final Property<Boolean> _headJump = Unmodified("move.jump.head.charge").key("move.forward.jump.charge", _pre_sm_1_8).depends(this._jump).comment("Relevant only if \"move.jump\" is not false").chapter("Head jumping", "Below you find all head jump and fall specific options except those for exhaustion.");
    ...
    public final Property<Float> _wallHeadJumpFallMaximumDistance = Positive("move.jump.wall.head.fall.maximum.distance").defaults(3F).min(this._wallUpJumpFallMaximumDistance).comment("Distance in blocks to fall to block all wall head jumping attempts (>= \"move.jump.wall.fall.maximum.distance\")");
    ...
    private final Property<Float> _old_sneakJumpExhaustionGain = Positive("move.sneak.jump.exhaustion.gain", _pre_sm_1_7).down(45F, this._old_jumpExhaustionGain).defaults(10F, _pre_sm_1_4);
    private final Property<Float> _old_sneakJumpExhaustionStop = Positive("move.sneak.jump.exhaustion.stop", _pre_sm_1_7).up(55F, this._old_jumpExhaustionStop).defaults(100F, _pre_sm_1_4);
    ...
    private final Property<Float> _old_sprintJumpExhaustionGain = Positive("move.sprint.jump.exhaustion.gain", _pre_sm_1_7_post_1_0).key("move.exhaustion.sprint.jump.gain", _sm_1_0).up(65F, this._old_runJumpExhaustionGain).defaults(20F, _pre_sm_1_4);
    private final Property<Float> _old_sprintJumpExhaustionStop = Positive("move.sprint.jump.exhaustion.stop", _pre_sm_1_7_post_1_0).key("move.exhaustion.sprint.jump.stop", _sm_1_0).down(35F, this._old_runJumpExhaustionStop).defaults(100F, _pre_sm_1_4);
    ...
    public final Property<Boolean> _upJumpExhaustion = Unmodified("move.jump.up.exhaustion").depends(this._jumpExhaustion).comment("To switch on/off up jump exhaustion").chapter();
    ...
    public final Property<Boolean> _climbJumpExhaustion = Hard("move.jump.climb.exhaustion").depends(this._jumpExhaustion).comment("To switch on/off climb jump exhaustion").chapter();
    ...
    public final Property<Boolean> _climbJumpUpExhaustion = Unmodified("move.jump.climb.up.exhaustion").depends(this._climbJumpExhaustion).comment("To switch on/off climb up jump exhaustion").section();
    ...
    public final Property<Boolean> _climbJumpBackUpExhaustion = Unmodified("move.jump.climb.back.up.exhaustion").depends(this._climbJumpExhaustion).comment("To switch on/off climb back jump exhaustion").section();
    ...
    public final Property<Boolean> _climbJumpBackHeadExhaustion = Unmodified("move.jump.climb.back.head.exhaustion").depends(this._climbJumpExhaustion).comment("To switch on/off back climb head jump exhaustion").section();
    ...
    public final Property<Boolean> _angleJumpExhaustion = Unmodified("move.jump.angle.exhaustion").depends(this._jumpExhaustion).comment("To switch on/off angle jump exhaustion").chapter();
    ...
    public final Property<Boolean> _wallJumpExhaustion = Medium("move.jump.wall.exhaustion").depends(this._jumpExhaustion).comment("To switch on/off wall jump exhaustion").chapter();
    ...
    public final Property<Boolean> _wallUpJumpExhaustion = Unmodified("move.jump.wall.up.exhaustion").depends(this._wallJumpExhaustion).comment("To switch on/off wall up jump exhaustion").section();
    ...
    public final Property<Boolean> _wallHeadJumpExhaustion = Unmodified("move.jump.wall.head.exhaustion").depends(this._wallJumpExhaustion).comment("To switch on/off wall head jump exhaustion").section();
    ...
    public final Property<Boolean> _standJumpExhaustion = Hard("move.jump.stand.exhaustion").depends(this._jumpExhaustion).source(this._old_jumpExhaustion, _pre_sm_1_7).comment("To switch on/off stand jump exhaustion").chapter();
    public final Property<Float> _standJumpExhaustionGainFactor = PositiveFactor("move.jump.stand.exhaustion.gain.factor").defaults(40F).source(this._old_jumpExhaustionGain, _pre_sm_1_7).comment("To manipulate the exhaustion increase by a jump while standing (>= 0)");
    public final Property<Float> _standJumpExhaustionStopFactor = PositiveFactor("move.jump.stand.exhaustion.stop.factor").defaults(60F).source(this._old_jumpExhaustionStop, _pre_sm_1_7).comment("To manipulate maximum exhaustion to jump while standing (>= 0)");
    public final Property<Boolean> _sneakJumpExhaustion = Hard("move.jump.sneak.exhaustion").depends(this._jumpExhaustion).source(this._old_sneakJumpExhaustion, _pre_sm_1_7).comment("To switch on/off sneak jump exhaustion").section();
    public final Property<Float> _sneakJumpExhaustionGainFactor = PositiveFactor("move.jump.sneak.exhaustion.gain.factor").up(40F, this._standJumpExhaustionGainFactor).source(this._old_sneakJumpExhaustionGain, _pre_sm_1_7).comment("To manipulate the exhaustion increase by a jump while sneaking (>= \"move.jump.stand.exhaustion.gain.factor\")");
    public final Property<Float> _sneakJumpExhaustionStopFactor = PositiveFactor("move.jump.sneak.exhaustion.stop.factor").down(60F, this._standJumpExhaustionStopFactor).source(this._old_sneakJumpExhaustionStop, _pre_sm_1_7).comment("To manipulate maximum exhaustion to jump while sneaking (>= 0, <= \"move.jump.stand.exhaustion.stop.factor\")");
    public final Property<Boolean> _walkJumpExhaustion = Hard("move.jump.walkexhaustion").depends(this._jumpExhaustion).source(this._old_jumpExhaustion, _pre_sm_1_7).comment("To switch on/off walk jump exhaustion").section();
    public final Property<Float> _walkJumpExhaustionGainFactor = PositiveFactor("move.jump.walk.exhaustion.gain.factor").up(45F, this._sneakJumpExhaustionGainFactor).source(this._old_jumpExhaustionGain, _pre_sm_1_7).comment("To manipulate the exhaustion increase by a jump while walking (>= \"move.jump.sneak.exhaustion.gain.factor\")");
    public final Property<Float> _walkJumpExhaustionStopFactor = PositiveFactor("move.jump.walk.exhaustion.stop.factor").down(55F, this._sneakJumpExhaustionStopFactor).source(this._old_jumpExhaustionStop, _pre_sm_1_7).comment("To manipulate maximum exhaustion to jump while walking (>= 0, <= \"move.jump.sneak.exhaustion.stop.factor\")");
    public final Property<Boolean> _runJumpExhaustion = Medium("move.jump.run.exhaustion").depends(this._jumpExhaustion).source(this._old_runJumpExhaustion, _pre_sm_1_7).comment("To switch on/off run jump exhaustion").section();
    public final Property<Float> _runJumpExhaustionGainFactor = PositiveFactor("move.jump.run.exhaustion.gain.factor").up(60F, this._walkJumpExhaustionGainFactor).source(this._old_runJumpExhaustionGain, _pre_sm_1_7).comment("To manipulate the exhaustion increase by a jump while running (>= \"move.jump.walk.exhaustion.gain.factor\")");
    public final Property<Float> _runJumpExhaustionStopFactor = PositiveFactor("move.jump.run.exhaustion.stop.factor").down(40F, this._walkJumpExhaustionStopFactor).source(this._old_runJumpExhaustionStop, _pre_sm_1_7).comment("To manipulate maximum exhaustion to jump while running (>= 0, <= \"move.jump.walk.exhaustion.stop.factor\")");
    public final Property<Boolean> _sprintJumpExhaustion = Medium("move.jump.sprint.exhaustion").depends(this._jumpExhaustion).source(this._old_sprintJumpExhaustion, _pre_sm_1_7).comment("To switch on/off sprint jump exhaustion").section();
    public final Property<Float> _sprintJumpExhaustionGainFactor = PositiveFactor("move.jump.sprint.exhaustion.gain.factor").up(65F, this._runJumpExhaustionGainFactor).source(this._old_sprintJumpExhaustionGain, _pre_sm_1_7).comment("To manipulate the exhaustion increase by a jump while sprinting (>= \"move.jump.run.exhaustion.gain.factor\")");
    public final Property<Float> _sprintJumpExhaustionStopFactor = PositiveFactor("move.jump.sprint.exhaustion.stop.factor").down(35F, this._runJumpExhaustionStopFactor).source(this._old_sprintJumpExhaustionStop, _pre_sm_1_7).comment("To manipulate maximum exhaustion to jump while sprinting (>= 0, <= \"move.jump.run.exhaustion.stop.factor\")");
    public final Property<Boolean> _jumpChargeExhaustion = Medium("move.jump.charge.exhaustion").depends(this._jumpExhaustion).defaults(true, _pre_sm_1_11).comment("To switch on/off up additional jump charge exhaustion").section();
    ...
    public final Property<Boolean> _jumpSlideExhaustion = Medium("move.jump.slide.exhaustion").depends(this._jumpExhaustion).defaults(true, _pre_sm_1_11).comment("To switch on/off slide jump exhaustion").section();
    ...
    public final Property<Float> _runningExhautionLossFactor = PositiveFactor("move.exhaustion.run.loss.factor").up(0.5F, this._sprintingExhautionLossFactor).comment("Standard sprinting exhaustion loss factor while (>= 0, >= \"move.exhaustion.sprint.loss.factor\")");
    public final Property<Float> _walkingExhautionLossFactor = PositiveFactor("move.exhaustion.walk.loss.factor").up(1F, this._runningExhautionLossFactor).comment("Walking exhaustion loss factor (>= 0, >= \"move.exhaustion.run.loss.factor\")");
    public final Property<Float> _sneakingExhautionLossFactor = PositiveFactor("move.exhaustion.sneak.loss.factor").up(1.5F, this._walkingExhautionLossFactor).defaults(1F, _sm_1_1).comment("Sneaking exhaustion loss factor (>= 0, >= \"move.exhaustion.walk.loss.factor\")");
    public final Property<Float> _standingExhautionLossFactor = PositiveFactor("move.exhaustion.stand.loss.factor").up(2F, this._sneakingExhautionLossFactor.maximum(1F)).comment("Standing exhaustion loss factor (>= 1, >= \"move.exhaustion.sneak.loss.factor\")");
    public final Property<Float> _fallExhautionLossFactor = PositiveFactor("move.exhaustion.fall.loss.factor").up(2.5F, this._standingExhautionLossFactor).comment("Falling exhaustion loss factor (>= \"move.exhaustion.stand.loss.factor\")");
    ...
    public final Property<Float> _usageSwordSpeedFactor = DecreasingFactor("move.usage.sword.speed.factor").defaults(this._usageSpeedFactor).comment("Speed factor while blocking with a sword (>= 0 AND <= 1, defaults to \"move.usage.speed.factor\" when not present)");
    public final Property<Float> _usageBowSpeedFactor = DecreasingFactor("move.usage.bow.speed.factor").defaults(this._usageSpeedFactor).comment("Speed factor while pulling back a bow (>= 0 AND <= 1, defaults to \"move.usage.speed.factor\" when not present)");
    public final Property<Float> _usageFoodSpeedFactor = DecreasingFactor("move.usage.food.speed.factor").defaults(this._usageSpeedFactor).comment("Speed factor while eating food (>= 0 AND <= 1, defaults to \"move.usage.speed.factor\" when not present)");
    ...
    public final Property<Boolean> _globalConfig = Modified("move.global.config").key("move.config.overwrite", _pre_sm_3_0).key("move.config.send", _pre_sm_2_2).singular().depends(this._serverConfig).comment("Whether all players on this server should be forced to use the same global configuration (Relevant only if \"move.server.config\" is true)").section();
    ...
    {
        this._speedUserExponent.setValue(this._speedUserExponent.getValue() + difference);
    }

    public boolean isUserSpeedEnabled()
    {
        return this.enabled && this._speedUser.getValue();
    }

    public boolean isUserSpeedAlwaysDefault()
    {
        return !this._speedUser.getValue() || this._speedUserFactor.getValue() == 1F;
    }

    public float getUserSpeedFactor()
    {
        if (this.isUserSpeedAlwaysDefault() || this._speedUserExponent.getValue() == 0) {
            return 1F;
        }
        return (float) Math.pow(1F + this._speedUserFactor.getValue(), this._speedUserExponent.getValue());
    }

    protected void loadFromProperties(net.smart.properties.Properties properties)
    {
        try {
    ...
    {
        net.smart.properties.Properties slcs_properties = new net.smart.properties.Properties(_slcs, new File(optionsPath, _smartLadderClimbingSpeedPropertiesFileName));
        net.smart.properties.Properties sc_properties = new net.smart.properties.Properties(_sc, new File(optionsPath, _smartClimbingPropertiesFileName));
        net.smart.properties.Properties sm_cs_properties = new net.smart.properties.Properties(new File(optionsPath, _smartMovingClientServerPropertiesFileName));
        net.smart.properties.Properties properties = new net.smart.properties.Properties(new File(optionsPath, _smartMovingPropertiesFileName));
    ...
    {
        try {
            this.save(new File(optionsPath, _smartMovingPropertiesFileName), _sm_current, true, true);
        } catch (Exception e) {
    ...
    {
        float factor = this.getUserSpeedFactor() * 100F;
        int fraction = 0;
        while (factor < 100F) {
            fraction++;
            factor *= 10F;
